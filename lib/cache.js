...
// A utility method that can cache the results of an async method
// call. The method (asyncMethod) must accept a single argument as]
// input, and execute the callback. The signatures should be:
//  * function myAsyncMethod(options, callback)
//  * function myAsyncCallback(error, value)
var CachedAsyncMethod = (function CachedAsyncMethodClosure() {
	...
	function processAsyncMethod(callback) {
		...
		this.options.method(this.options.args, function(error, value) {
...
module.exports.AsyncMethod = CachedAsyncMethod;
